...
plotUniqueEvents(finalCNfreq, background_freq, , difference_only = TRUE,fontsize_chr=22, fontsize_leg_title=22, fontsize_leg_label=18)
...
finalCN@assayData$copynumber[,"SINCEL-274_Plate_414_P22"]
